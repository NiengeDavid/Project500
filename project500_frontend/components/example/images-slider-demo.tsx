  ...
  return (
    <ImagesSlider className="h-[40rem]" images={images}>
      ...
      >
        ...
        <a href="#sponsor" className="px-4 py-2 backdrop-blur-sm border bg-emerald-300/10 border-emerald-500/20 text-white mx-auto text-center rounded-full relative mt-4">
          <span>Join now →</span>
